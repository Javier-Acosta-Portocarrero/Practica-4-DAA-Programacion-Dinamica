...
// Fecha: 16/03/2026
// Archivo factory_divide_y_venceras_binario.cc: fichero de definición.
// Contiene la definición de la clase FactoryDivideYVencerasBinario.
...
FactoryDivideYVencerasBinario::FactoryDivideYVencerasBinario(SelectorFactoryAlgoritmo* selector)
    : selector_(selector) {}

Algoritmo* FactoryDivideYVencerasBinario::Crear(const json& config) {
